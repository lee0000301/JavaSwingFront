...
public class LoginUI extends JFrame {
    ...
    private JButton customerButton; // 고객 전용 화면 버튼
    ...
    private final Color BUTTON_CUSTOMER = new Color(52, 101, 164);
    ...
    private JPanel createContentPanel() {
        ...
        customerButton = new JButton("고객 전용 화면");
        customerButton.setFont(new Font("맑은 고딕", Font.BOLD, 16));
        customerButton.setBounds(50, 310, 450, 50);
        customerButton.setBackground(BUTTON_CUSTOMER);
    ...
    private void handleCustomerScreen() {
        JOptionPane.showMessageDialog(this, "고객 전용 화면으로 이동합니다.", "고객 화면", JOptionPane.INFORMATION_MESSAGE);
        dispose(); // 로그인 창 닫기
        new CustomerMainUI();
